        ...
        <form id="searchUserForm">
            <table>
                <tr>
                    ...
                    <th>创建时间:</th>
                    <td>
                        <input  name="createdateStart" type="text" class="easyui-datetimebox"   data-options="editable:false"/>
                        至
                        <input  name="createdateEnd"  type="text" class="easyui-datetimebox" data-options="editable:false" />
