        ...
        $('#projectDataGrid').datagrid({
                onClickRow:function(rowIndex,rowData){
                    if(rowIndex==0){
                        $('#test').datagrid({
                            data: [
                                {test0:'审计方法讨论', test2:'审计过程信息',test3:'admin',test4:'于2018年8月30日10:47:42在北京开始面谈'},
                                {test0:'去办公现场勘查', test2:'现场勘查',test3:'admin',test4:'于2018年8月30日10:47:42在北京开始面谈'},
                                {test0:'项目监督结果', test2:'监督盘点',test3:'admin',test4:'于2018年8月30日10:47:42在北京开始面谈'}
                            ]
                        });  $('#test1').datagrid({
                            data: [
                                {test0:'中介考核', test1:'中介考核信息',test2:'日常考核',test3:'admin',test4:'考核的不错'}
                            ]
                        });  $('#test2').datagrid({
                            data: [
                                {test0:'审计费全部核算完成', test1:'审计费核算信息',test2:'自动计算项目审计费',test3:'admin',test4:'自动计算项目审计费'}
                            ]
                        });  $('#test3').datagrid({
                            data: [
                                {test0:'审计成果没有问题', test1:'审计成果信息',test2:'挂接中介机构审核报告',test3:'admin',test4:'挂接中介机构审核报告'}
                            ]
                        });
                    }else{
                        $('#test').datagrid({
                            data: [
                                {test0:'办公审计信息', test1:'审计过程信息',test2:'审计面谈',test3:'admin',test4:'于2018在山东开始面谈'}
                            ]
                        }); $('#test1').datagrid({
                            data: [
                                {test0:'这次采购考核结果', test1:'中介考核信息',test2:'日常考核',test3:'admin',test4:'不行！不行！不行！'}
                            ]
                        }); $('#test2').datagrid({
                            data: [
                                {test0:'审计费核实没问题', test1:'审计费核算信息',test2:'自动计算项目审计费',test3:'admin',test4:'自动进行计算'}
                            ]
                        }); $('#test3').datagrid({
                            data: [
                                {test0:'审计结果信息', test1:'审计成果信息',test2:'挂接中介机构审核报告',test3:'admin',test4:'挂接中介机构审核报告'}
                            ]
                        });
                    }
        ...
        <div class="easyui-layout" style="width:100%;height:100%;">
            <div data-options="region:'center'"  style="overflow: hidden;height: 60%">
                <table id="projectDataGrid" class="easyui-datagrid" width="100%"
                       data-options="fit:true,border:false,fitColumns:true,singleSelect:true,toolbar:'#projectToolbar'">
                    <thead>
                    <tr>
                        <th data-options="field:'code',width:100">项目名称</th>
